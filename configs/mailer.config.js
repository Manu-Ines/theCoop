										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
											...
											<tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" role="presentation">
													...
													<tr>
														<td style="padding: 13px 17px; border-radius: 8px; background-color: #1595E7;" bgcolor="#1595E7" valign="top" align="center">
														<a href="${process.env.HOST || `http://localhost:${process.env.PORT || 3000}`}/activate-email/${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Activar cuenta</a>
														</td>
													</tr>
													</tbody>
												</table>
...
module.exports.sendChangePassEmail = (email, token) => {
	transporter.sendMail({
			...
			text: "Veifica este email para cambiar tu contraseña de la cuenta de rodiles",
			html: `
								<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
				<head>
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
											...
											<tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" role="presentation">
													...
													<tr>
														<td style="padding: 13px 17px; border-radius: 8px; background-color: #1595E7;" bgcolor="#1595E7" valign="top" align="center">
														<a href="${process.env.HOST || `http://localhost:${process.env.PORT || 3000}`}/change-inaction/${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Activar cuenta</a>
														</td>
													</tr>
													</tbody>
												</table>
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
											...
											<tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" role="presentation">
													...
													<tr>
														<td style="padding: 13px 17px; border-radius: 8px; background-color: #1595E7;" bgcolor="#1595E7" valign="top" align="center">
														<a href="${process.env.HOST || `http://localhost:${process.env.PORT || 3000}`}/change-inaction-social/${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Activar cuenta</a>
														</td>
													</tr>
													</tbody>
												</table>
