...
module.exports.sendFinalEmail = (email, message, org) => {
  transporter
      .sendMail({
          from: `"Coop" <thecoopspain@gmail.com>`,
          to: email,
          subject: 'Ha sido posible gracias a ti',
          text: 'Agradecimiento',
          html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
                    ...
                    <tr>
                      <td class="pc-sm-p-30-20-25 pc-xs-p-25-10-20" style="padding: 40px 30px 35px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                          <tbody>
                            <tr>
                              <td class="pc-sm-fs-30 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; line-height: 46px; letter-spacing: -0.6px; color: #151515; padding: 0 10px;" valign="top">${org} quiere agradecerte tu colaboración:</td>
                            </tr>
                            <tr>
                              <td height="15" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
                            </tr>
